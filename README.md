# Projeto-de-software_Artigos
Este repositório centraliza as resenhas críticas e análises técnicas desenvolvidas para a disciplina de **Projeto de Software**. O foco aqui é documentar o estudo dos fundamentos teóricos que sustentam o desenvolvimento de sistemas modernos.

## 📖 Catálogo de Resenhas

Abaixo estão os artigos analisados durante o semestre. Cada link leva à resenha completa com os principais conceitos e conclusões:
